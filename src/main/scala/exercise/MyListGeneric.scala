...
object EmptyListGeneric extends MyListGeneric[Nothing] {
  ...
  def add[B >: Nothing](element: B): MyListGeneric[B] = new ConsGeneric(element, EmptyListGeneric)
  def printElements: String = ""
}
...
object GenericListTest extends App {
  val listInt: MyListGeneric[Int] = new ConsGeneric[Int](1, new ConsGeneric[Int](2, new ConsGeneric[Int](3, EmptyListGeneric)))
  println(listInt.toString)
  val listStr: MyListGeneric[String] = new ConsGeneric[String]("first", new ConsGeneric[String]("second", new ConsGeneric[String]("three", EmptyListGeneric)))
